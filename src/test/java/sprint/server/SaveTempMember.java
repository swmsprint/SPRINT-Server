...
public class SaveTempMember {
    ...
    public void Save5TestMember() {
        Member member1 = Member.createMember("Test1", Gender.FEMALE, "test1@sprint.com", LocalDate.of(2011, 2, 28), 180.0f, 70f, null);
        Member member2 = Member.createMember("Test2", Gender.FEMALE, "test2@sprint.com", LocalDate.of(2012, 2, 12), 166.0f, 65f, null);
        ...
        Member member5 = Member.createMember("Test5", Gender.FEMALE, "test5@sprint.com", LocalDate.of(2009, 4, 28), 180.0f, 70f, null);
